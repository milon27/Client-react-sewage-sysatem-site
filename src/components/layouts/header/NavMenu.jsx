            ...
            <header className="header" itemScope itemType="http://schema.org/WPHeader">
                <div className="container-fluid">
                    <div className="row justify-content-between">
                        <a className="logo__link" href="https://magnaplast.pl/en">
                            <img className="logo__img" src="https://magnaplast.pl/images/xlogo.png.pagespeed.ic._DqDSRYo5Z.png" />
                        </a>
                        ...
                        <div className="main-menu">
                            <ul className="nav menu main-menu__list mod-list">
                                <li className="item-101 default current active"><a href="/en/">Home</a></li>
                                ...
                                <li className="item-141 deeper parent"><a href="/en/products" className="sub-sub-menu">Products</a>
                                    <ul className="nav-child unstyled small">
                                        <li className="item-160 deeper parent"><a href="#">Indoor sewage system (PP)</a>
                                            <ul className="nav-child unstyled small">
                                                <li className="item-161"><a href="/en/produkty/kanalizacja-wewnetrzna-pp/htplus">HTplus</a></li>
                                                <li className="item-162"><a href="/en/produkty/kanalizacja-wewnetrzna-pp/ultra-db">Ultra dB</a></li>
                                                <li className="item-164"><a href="/en/products/indoor-sewage-systems/skolan-db">Skolan safe</a></li>
                                            </ul>
                                        </li>
                                        <li className="item-163 deeper parent"><a href="#">Outdoor sewage system</a>
                                            <ul className="nav-child unstyled small">
                                                <li className="item-167"><a href="/en/produkty/kanalizacja-zewnetrzna/kg">KG</a>
                                                </li>
                                                <li className="item-165"><a href="/en/produkty/kanalizacja-zewnetrzna/magnacor">Magnacor</a></li>
                                                <li className="item-166"><a href="/en/produkty/kanalizacja-zewnetrzna/kg-2000">KG
                                                    2000</a></li>
                                            </ul>
                                        </li>
                                        <li className="item-168"><a href="/en/products/inspection-chamber-systems">Inspection
                                            chamber systems</a></li>
                                        <li className="item-169"><a href="/en/products/water-piping-systems">Water piping
                                            systems</a></li>
                        ...
                        <div className="search mod_search112">
                            <form action="/en/" method="post" className="form-inline" role="search">
                                ...
                                </svg> <input name="searchword" id="mod-search-searchword112" maxLength={200} className="inputbox search-query input-medium" type="search" size={15} placeholder="Search ..." /> <input type="hidden" name="task" defaultValue="search" />
