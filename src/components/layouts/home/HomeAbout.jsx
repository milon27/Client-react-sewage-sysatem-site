...
export default function HomeAbout() {
    return (
        <>
            <section className="heading-text bg-gray-3">
                    ...
                    <div className="row">
                        <div className="col-md-10 offset-md-1">
                            ...
                            <p>
                                ...
                                enhanced PP products sought-after on the market while their market share, in comparison with
                                traditional solutions based on PP or PVC-U, is on the increase by the day.
                                The Ultra dB system versions are available with the diameters of 40,50, 75, 110, 125, 160 and 200 mm.
                                The combination of the material composition and wall thickness ensures a very high degree of
                                sound insulation, since the noise level is as low as 16 dB. Lip seals made of a rubber-based
                                compound are used to connect the system components with one another.
                                As the pipes are lightweight, their installation is easy. Thanks to the smooth inner surface of each
                                pipe, waste water encounters little resistance as it is drained, which even if the conduit gradient is
                                extremely slight prevents deposits from forming. Consistently, no sewage putrefaction occurs in
                                the pipes, which thus remain unclogged.
                            </p>
                        </div>
                    </div>
                </div>
